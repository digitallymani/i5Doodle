...
function fnSavingImageUpdate(paramFileName){
	...
	//var paramUrl="http://localhost/~manigandan_g/i5Doodle/i5Doodle/";
	var paramUrl="http://ec2-174-129-90-42.compute-1.amazonaws.com/i5DoodleDev/";

		
	FB.ui(  {
	     method: 'feed',
	     name: 'i5Doodle',
	     link:  paramUrl + paramFileName,
	     picture: paramUrl + paramFileName,
	     caption: 'I just created a i5Doodle.',
